...
puts count_correct_characters("dog", "car"); #0 (No letters are in the correct position)
puts count_correct_characters("dog", "god"); #1 ("o")
puts count_correct_characters("dog", "cog"); #2 ("o" and "g")
puts count_correct_characters("dog", "cod"); #1 ("o")
puts count_correct_characters("dog", "bog"); #2 ("o" and "g")
puts count_correct_characters("dog", "dog"); #3 (Correct!)
